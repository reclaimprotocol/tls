 ...
 */
export const MOZILLA_ROOT_CA_LIST = [`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Actalis Authentication Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TunTrust Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Amazon Root CA 1
`-----BEGIN CERTIFICATE-----
...
4PsJYGw=
-----END CERTIFICATE-----`, //Amazon Root CA 2
`-----BEGIN CERTIFICATE-----
...
YyRIHN8wfdVoOw==
-----END CERTIFICATE-----`, //Amazon Root CA 3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Amazon Root CA 4
`-----BEGIN CERTIFICATE-----
...
sSi6
-----END CERTIFICATE-----`, //Starfield Services Root Certificate Authority - G2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Certum EC-384 CA
`-----BEGIN CERTIFICATE-----
...
DrW5viSP
-----END CERTIFICATE-----`, //Certum Trusted Network CA 2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Certum Trusted Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Autoridad de Certificacion Firmaprofesional CIF A62634068
`-----BEGIN CERTIFICATE-----
...
XSaQpYXFuXqUPoeovQA=
-----END CERTIFICATE-----`, //FIRMAPROFESIONAL CA ROOT-A WEB
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //ANF Secure Server Root CA
`-----BEGIN CERTIFICATE-----
...
r/6zcCwupvI=
-----END CERTIFICATE-----`, //BJCA Global Root CA1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //BJCA Global Root CA2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Buypass Class 2 Root CA
`-----BEGIN CERTIFICATE-----
MIIFWTCCA0GgAwIBAgIBAjANBgkqhkiG9w0BAQsFADBOMQswCQYDVQQGEwJOTzEd
MBsGA1UECgwUQnV5cGFzcyBBUy05ODMxNjMzMjcxIDAeBgNVBAMMF0J1eXBhc3Mg
...
-----END CERTIFICATE-----`, //Buypass Class 3 Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Certainly Root E1
`-----BEGIN CERTIFICATE-----
...
OV+KmalBWQewLK8=
-----END CERTIFICATE-----`, //Certainly Root R1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Certigna Root CA
`-----BEGIN CERTIFICATE-----
...
9u6wWk5JRFRYX0KD
-----END CERTIFICATE-----`, //certSIGN ROOT CA
`-----BEGIN CERTIFICATE-----
...
QRBdJ3NghVdJIgc=
-----END CERTIFICATE-----`, //certSIGN ROOT CA G2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //ePKI Root Certification Authority
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //HiPKI Root CA - G1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //CommScope Public Trust ECC Root-01
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //CommScope Public Trust ECC Root-02
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //CommScope Public Trust RSA Root-01
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //CommScope Public Trust RSA Root-02
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SecureSign Root CA12
`-----BEGIN CERTIFICATE-----
...
JRNItX+S
-----END CERTIFICATE-----`, //SecureSign Root CA14
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SecureSign Root CA15
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //D-TRUST BR Root CA 1 2020
`-----BEGIN CERTIFICATE-----
...
hJ65bvspmZDogNOfJA==
-----END CERTIFICATE-----`, //D-TRUST BR Root CA 2 2023
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //D-TRUST EV Root CA 1 2020
`-----BEGIN CERTIFICATE-----
...
XBxvWHZks/wCuPWdCg==
-----END CERTIFICATE-----`, //D-TRUST EV Root CA 2 2023
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //D-TRUST Root CA 3 2013
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //D-TRUST Root Class 3 CA 2 2009
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //D-TRUST Root Class 3 CA 2 EV 2009
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //D-Trust SBR Root CA 1 2022
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //D-Trust SBR Root CA 2 2022
`-----BEGIN CERTIFICATE-----
...
BSeOE6Fuwg==
-----END CERTIFICATE-----`, //T-TeleSec GlobalRoot Class 2
`-----BEGIN CERTIFICATE-----
MIIDwzCCAqugAwIBAgIBATANBgkqhkiG9w0BAQsFADCBgjELMAkGA1UEBhMCREUx
KzApBgNVBAoMIlQtU3lzdGVtcyBFbnRlcnByaXNlIFNlcnZpY2VzIEdtYkgxHzAd
BgNVBAsMFlQtU3lzdGVtcyBUcnVzdCBDZW50ZXIxJTAjBgNVBAMMHFQtVGVsZVNl
...
TpPDpFQUWw==
-----END CERTIFICATE-----`, //T-TeleSec GlobalRoot Class 3
`-----BEGIN CERTIFICATE-----
...
S0B/Sl+yZ1pzdcI=
-----END CERTIFICATE-----`, //Telekom Security SMIME ECC Root 2021
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Telekom Security SMIME RSA Root 2023
`-----BEGIN CERTIFICATE-----
...
27iQ7t0l
-----END CERTIFICATE-----`, //Telekom Security TLS ECC Root 2020
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Telekom Security TLS RSA Root 2023
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //DigiCert Assured ID Root CA
`-----BEGIN CERTIFICATE-----
...
IhNzbM8m9Yop5w==
-----END CERTIFICATE-----`, //DigiCert Assured ID Root G2
`-----BEGIN CERTIFICATE-----
...
6pZjamVFkpUBtA==
-----END CERTIFICATE-----`, //DigiCert Assured ID Root G3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //DigiCert Global Root CA
`-----BEGIN CERTIFICATE-----
...
MrY=
-----END CERTIFICATE-----`, //DigiCert Global Root G2
`-----BEGIN CERTIFICATE-----
...
sycX
-----END CERTIFICATE-----`, //DigiCert Global Root G3
`-----BEGIN CERTIFICATE-----
...
+OkuE6N36B9K
-----END CERTIFICATE-----`, //DigiCert High Assurance EV Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //DigiCert SMIME ECC P384 Root G5
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //DigiCert SMIME RSA4096 Root G5
`-----BEGIN CERTIFICATE-----
...
DXZDjC5Ty3zfDBeWUA==
-----END CERTIFICATE-----`, //DigiCert TLS ECC P384 Root G5
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //DigiCert TLS RSA4096 Root G5
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //DigiCert Trusted Root G4
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //DIGITALSIGN GLOBAL ROOT RSA CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //CA Disig Root R2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //GLOBALTRUST 2020
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //emSign ECC Root CA - C3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //emSign ECC Root CA - G3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //emSign Root CA - C1
`-----BEGIN CERTIFICATE-----
...
iN66zB+Afko=
-----END CERTIFICATE-----`, //emSign Root CA - G1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //AffirmTrust Commercial
`-----BEGIN CERTIFICATE-----
...
KeC2uAloGRwYQw==
-----END CERTIFICATE-----`, //AffirmTrust Premium
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //AffirmTrust Premium ECC
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Entrust Root Certification Authority
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Entrust Root Certification Authority - EC1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Entrust Root Certification Authority - G2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Entrust Root Certification Authority - G4
`-----BEGIN CERTIFICATE-----
...
fF6adulZkMV8gzURZVE=
-----END CERTIFICATE-----`, //Entrust.net Certification Authority (2048)
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Atos TrustedRoot 2011
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Atos TrustedRoot Root CA ECC G2 2020
`-----BEGIN CERTIFICATE-----
...
9H1/IISpQuQo
-----END CERTIFICATE-----`, //Atos TrustedRoot Root CA ECC TLS 2021
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Atos TrustedRoot Root CA RSA G2 2020
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Atos TrustedRoot Root CA RSA TLS 2021
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //GDCA TrustAUTH R5 ROOT
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //GlobalSign Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //GlobalSign Root E46
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //GlobalSign Secure Mail Root E45
`-----BEGIN CERTIFICATE-----
...
s8H2PA==
-----END CERTIFICATE-----`, //GlobalSign Secure Mail Root R45
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Go Daddy Class 2 Certification Authority
`-----BEGIN CERTIFICATE-----
...
4uJEvlz36hz1
-----END CERTIFICATE-----`, //Go Daddy Root Certificate Authority - G2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Starfield Class 2 Certification Authority
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Starfield Root Certificate Authority - G2
`-----BEGIN CERTIFICATE-----
...
mpv0
-----END CERTIFICATE-----`, //Hongkong Post Root CA 3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //AC RAIZ FNMT-RCM
`-----BEGIN CERTIFICATE-----
...
v+c=
-----END CERTIFICATE-----`, //AC RAIZ FNMT-RCM SERVIDORES SEGUROS
`-----BEGIN CERTIFICATE-----
...
94B7IWcnMFk=
-----END CERTIFICATE-----`, //Staat der Nederlanden Root CA - G3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TUBITAK Kamu SM SSL Kok Sertifikasi - Surum 1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //HARICA Client ECC Root CA 2021
`-----BEGIN CERTIFICATE-----
...
ac8sqzuEYDMZUv1pFDM=
-----END CERTIFICATE-----`, //HARICA Client RSA Root CA 2021
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //HARICA TLS ECC Root CA 2021
`-----BEGIN CERTIFICATE-----
...
63ZTGI0RmLo=
-----END CERTIFICATE-----`, //HARICA TLS RSA Root CA 2021
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Hellenic Academic and Research Institutions ECC RootCA 2015
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Hellenic Academic and Research Institutions RootCA 2015
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //IdenTrust Commercial Root CA 1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //IdenTrust Public Sector Root CA 1
`-----BEGIN CERTIFICATE-----
...
GJTO
-----END CERTIFICATE-----`, //vTrus ECC Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SZAFIR ROOT CA2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //LAWtrust Root CA2 (4096)
`-----BEGIN CERTIFICATE-----
...
+efcMQ==
-----END CERTIFICATE-----`, //e-Szigno Root CA 2017
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Microsec e-Szigno Root CA 2009
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Microsoft ECC Root Certificate Authority 2017
`-----BEGIN CERTIFICATE-----
...
RA+GsCyRxj3qrg+E
-----END CERTIFICATE-----`, //Microsoft RSA Root Certificate Authority 2017
`-----BEGIN CERTIFICATE-----
...
9XXeifdy
-----END CERTIFICATE-----`, //NAVER Global Root Certification Authority
`-----BEGIN CERTIFICATE-----
...
/L7fCg0=
-----END CERTIFICATE-----`, //OISTE WISeKey Global Root GA CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //OISTE WISeKey Global Root GB CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //OISTE WISeKey Global Root GC CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //QuoVadis Root CA 1 G3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //QuoVadis Root CA 2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //QuoVadis Root CA 2 G3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //QuoVadis Root CA 3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //QuoVadis Root CA 3 G3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Security Communication ECC RootCA1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Security Communication RootCA2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //AAA Certificate Services
`-----BEGIN CERTIFICATE-----
...
ZQ==
-----END CERTIFICATE-----`, //COMODO Certification Authority
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //COMODO ECC Certification Authority
`-----BEGIN CERTIFICATE-----
...
NVOFBkpdn627G190
-----END CERTIFICATE-----`, //COMODO RSA Certification Authority
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Sectigo Public Email Protection Root E46
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Sectigo Public Email Protection Root R46
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Sectigo Public Server Authentication Root E46
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Sectigo Public Server Authentication Root R46
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //USERTrust ECC Certification Authority
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //USERTrust RSA Certification Authority
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //UCA Extended Validation Root
`-----BEGIN CERTIFICATE-----
...
alqaTQ==
-----END CERTIFICATE-----`, //SSL.com Client ECC Root CA 2022
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SSL.com Client RSA Root CA 2022
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SSL.com EV Root Certification Authority ECC
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SSL.com EV Root Certification Authority RSA R2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SSL.com Root Certification Authority ECC
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SSL.com Root Certification Authority RSA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SSL.com TLS ECC Root CA 2022
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SSL.com TLS RSA Root CA 2022
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SwissSign Gold CA - G2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SwissSign RSA SMIME Root CA 2022 - 1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SwissSign RSA TLS Root CA 2022 - 1
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TWCA CYBER Root CA
`-----BEGIN CERTIFICATE-----
...
KwbQBM0=
-----END CERTIFICATE-----`, //TWCA Global Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TWCA Global Root CA G2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TWCA Root Certification Authority
`-----BEGIN CERTIFICATE-----
...
rBPuUBQemMc=
-----END CERTIFICATE-----`, //Telia Root CA v2
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TeliaSonera Root CA v1
`-----BEGIN CERTIFICATE-----
...
FGWsJwt0ivKH
-----END CERTIFICATE-----`, //TrustAsia Global Root CA G3
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TrustAsia Global Root CA G4
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TrustAsia SMIME ECC Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TrustAsia SMIME RSA Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TrustAsia TLS ECC Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //TrustAsia TLS RSA Root CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Secure Global CA
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //SecureTrust CA
`-----BEGIN CERTIFICATE-----
...
yeC2nOnOcXHebD8WpHk=
-----END CERTIFICATE-----`, //Trustwave Global Certification Authority
`-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`, //Trustwave Global ECC P256 Certification Authority
`-----BEGIN CERTIFICATE-----
...
Sw==
-----END CERTIFICATE-----`, //Trustwave Global ECC P384 Certification Authority
`-----BEGIN CERTIFICATE-----
